    ...
    <v-container fluid class="grid-list-xl pt-0 mt-n3">
      <v-row class="mt-4">
        ...
        <v-col cols="6" sm="6">
          ...
          <v-row>
            <v-col cols="4" sm="4" id="image1" style="display:none;">
...
export default {
  ...
  methods: {
    ...
    getpostdetails(id) {
      ...
      api
        ...
        .then(response => {
          ...
          this.days = response.data.days_after_post;
    ...
    updatePost() {
      let self = this;
      let formData = new FormData();
      formData.append("update_id", this.$route.params.id);
      ...
      api
        ...
        .then(function(response) {
          ...
          self.$router.push({
            name: "MyPosts",
            params: { id: self.$route.params.group_id }
          });
        })
        .catch(function(error) {
          console.log(error);
